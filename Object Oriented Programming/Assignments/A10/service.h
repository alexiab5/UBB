...
public:
    ...
    **/
    ...
    void updateUniqueTrenchCoatService(const TrenchCoat& trench);
    ...
    **/
    ...
    /**
     * Searches for a unique TrenchCoat in the repository.
     * A TrenchCoat is unique by its photograph link and its colour.
    **/
    int searchForUniqueTrenchCoat(const TrenchCoat& trench);
